...
from src.views.category_schema import category_schema, \
    ...
    full_category_response_subcategory_count
...
def get_categories(category_id):
    category_service, status = CategoryService.get_one_by_id_with_check(
        _id=category_id)

    return dict(data=category_service.category, message=status.message)
